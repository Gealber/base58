...
func Test_base58Encode32(t *testing.T) {
	...
	if Base58Encode32(data) != "G9L2SYsfcuFt3eQKHQwG7JVNztdv1bwLaPFAnm1v3Pre" {
		t.Fail()
	}

	out, err := Base58Decode32(Base58Encode32(data))
	if err != nil {
...
func Test_base58Encode64(t *testing.T) {
	...
	if Base58Encode64(data) != "a2kzMdVRfi2Q6oGKFC3ewWdpZfmGwNACGh3HJK4hsp8DeENS7wz4ZiwM4nJ4xr21EwVoa2TtHE87if7Paiv1aha" {
		t.Fail()
	}
	out, err := Base58Decode64(Base58Encode64(data))
	if err != nil {
		t.Fail()
	}
